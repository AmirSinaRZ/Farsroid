...
public class AppsFragmentActivity extends Fragment {
	...
	private double appsCount = 0;
	private HashMap<String, Object> map_2 = new HashMap<>();
	
	private ArrayList<HashMap<String, Object>> today_appsListMap = new ArrayList<>();
	...
	private RequestNetwork todayApps;
	private RequestNetwork.RequestListener _todayApps_request_listener;
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.apps_fragment, _container, false);
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		AppsRecycler = _view.findViewById(R.id.AppsRecycler);
		...
		todayApps = new RequestNetwork((Activity) getContext());
		todayReq = new RequestNetwork((Activity) getContext());
		
		_todayApps_request_listener = new RequestNetwork.RequestListener() {
			@Override
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				title.setText(String.valueOf((long)(Double.parseDouble(map_1.get("today_apps_count").toString()))).concat(" برنامه منتشر شده امروز"));
				appsCount = Double.parseDouble(map_1.get("today_apps_count").toString());
				todayReq.startRequestNetwork(RequestNetworkController.GET, Preferences.main_url + Preferences.today_apps_url, "AppsFragmentActivity", _todayReq_request_listener);
			}
	...
	public void _sendRequest() {
		todayApps.startRequestNetwork(RequestNetworkController.GET, Preferences.main_url + Preferences.today_cnt, "AppsFragmentActivity", _todayApps_request_listener);
	}
	
	
	public void _updateRecycler() {
		AppsRecycler.setAdapter(new AppsRecyclerAdapter(today_appsListMap));
		AppsRecycler.setLayoutManager(new GridLayoutManager(getActivity(), 3));
	}
	...
	public class AppsRecyclerAdapter extends RecyclerView.Adapter<AppsRecyclerAdapter.ViewHolder> {
		...
		public AppsRecyclerAdapter(ArrayList<HashMap<String, Object>> _arr) {
			_data = _arr;
		}
